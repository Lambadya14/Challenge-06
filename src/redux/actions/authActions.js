  ...
  (accessToken, navigate) => async (dispatch) => {
    try {
      ...
      let config = {
        ...
        url: `${process.env.REACT_APP_API_KM4}/v1/auth/google`,
        headers: {
  ...
  (navigate, navigatePath, navigatePathError) => async (dispatch, getState) => {
    try {
      ...
      const response = await axios.get(
        `${process.env.REACT_APP_API_KM4}/v1/auth/me`,
        {
          headers: {
...
export const login = (data, navigate) => async (dispatch) => {
  try {
    let config = {
      method: "post",
      url: `${process.env.REACT_APP_API_KM4}/v1/auth/login`,
      headers: {
        "Content-Type": "application/json",
      },
      data: data,
...
export const register = (data, navigate) => async (dispatch) => {
  try {
    let config = {
      method: "post",
      url: `${process.env.REACT_APP_API_KM4}/v1/auth/register`,
      headers: {
        "Content-Type": "application/json",
      },
      data: data,
